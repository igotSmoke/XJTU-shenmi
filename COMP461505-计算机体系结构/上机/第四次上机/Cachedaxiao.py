...
read_blocks = [155399, 155399, 155399, 155399]
write_blocks = [102350, 102350, 102350, 102350]
replacements = [11463, 4325, 1737, 598]
read_miss_rates = [2.58, 1.24, 0.47, 0.17]
write_miss_rates = [2.14, 1.21, 0.91, 0.81]
total_miss_rates = [1.16, 0.46, 0.22, 0.16]
...
table_data = [
    ...
    ['16KB', '4路', '64B', '022.li.din'],
    ['32KB', '4路', '64B', '022.li.din'],
    ['64KB', '4路', '64B', '022.li.din']
]
...
ax2.set_xticks(x)
ax2.set_xticklabels(cache_sizes, fontproperties=font)
ax2.legend(prop=font)
ax2.grid(True, linestyle='--', alpha=0.7)

# 3. 失效率统计
ax3 = plt.subplot2grid((2, 2), (1, 1))
x = np.arange(len(cache_sizes))  # 创建x轴位置数组
...
ax3.set_xticklabels(cache_sizes, fontproperties=font)  # 设置刻度标签
...
plt.tight_layout()
plt.savefig('cache_size_analysis.png', dpi=300, bbox_inches='tight')
# plt.show()  # 移除show()调用 