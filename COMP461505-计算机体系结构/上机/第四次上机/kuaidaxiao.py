...
read_blocks = [192459, 192459, 192459, 192459]
write_blocks = [9894, 9894, 9894, 9894]
replacements = [2401, 1460, 1025, 861]
read_miss_rates = [0.08, 0.09, 0.11, 0.14]
write_miss_rates = [21.12, 10.81, 5.48, 3.02]
total_miss_rates = [0.29, 0.17, 0.12, 0.09]
...
table_data = [
    ...
    ['8KB', '4路', '16B', '078.swm256.din'],
    ['8KB', '4路', '32B', '078.swm256.din'],
    ['8KB', '4路', '64B', '078.swm256.din'],
    ['8KB', '4路', '128B', '078.swm256.din']
]
...
ax2.set_xticks(x)
ax2.set_xticklabels(block_sizes, fontproperties=font)
ax2.legend(prop=font)
ax2.grid(True, linestyle='--', alpha=0.7)

# 3. 失效率统计
ax3 = plt.subplot2grid((2, 2), (1, 1))
x = np.arange(len(block_sizes))  # 创建x轴位置数组
...
ax3.set_xticklabels(block_sizes, fontproperties=font)  # 设置刻度标签
...
plt.tight_layout()
plt.savefig('cache_block_size_analysis.png', dpi=300, bbox_inches='tight') 